...
+ (instancetype)showHUDAddedToView:(NSView *)view animated:(BOOL)animated {
    MBProgressHUD *hud            = [[self alloc] initWithView:view];
...
+ (void)showText:(NSString *)text{
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedToView:[NSApplication sharedApplication].keyWindow.contentView animated:YES];
